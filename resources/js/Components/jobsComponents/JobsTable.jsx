...
export default function JobsTable({showErrorHandle, departments}) {
    ...
    return (
        ...
        <JobsModal show={showingModal} modalData={modalData} onHide={handleClose} key={modalData} showErrorHandle={showErrorHandle} departments={departments}/>
        </>
