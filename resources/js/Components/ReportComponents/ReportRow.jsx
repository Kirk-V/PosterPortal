...
export default function ReportRow({data}) {
  ...
  return (
    <tr>
        ...
        {data.requests.payment_method == 'speed_code' ? <td><ApproverReportCell Name={data.requests.approver_name} Type={data.requests.payment_method} Email={data.requests.approver_email}/></td>: <td>-</td>}
